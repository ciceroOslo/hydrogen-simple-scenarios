...
PACKAGE_NAME = "hydrogen-simple-scenarios"
AUTHORS = [
...
with open(README, "r") as f:
    README_LINES = ["hydrogen-simple-scenarios", "==============", ""]
    add_line = False
    for line in f:
...
class hydrogenSimpleScenarios(TestCommand):
...
cmdclass.update({"test": hydrogenSimpleScenarios})
...
setup(
    ...
    keywords=["cicero", "python", "hydrogen", "simple", "climate", "model"],
    packages=PACKAGES,
